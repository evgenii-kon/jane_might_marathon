...
def delete_exercise_confirm(
    ...
    return templates.TemplateResponse('admin/exercises/delete_confirm.html', {
        'request': request,
        'exercise': exercise,
        'user': current_user
    })
