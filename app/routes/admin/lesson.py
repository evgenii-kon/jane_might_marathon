...
def get_all_lessons(
    ...
    return templates.TemplateResponse(
        "admin/lessons/lessons_list.html", {"request": request, "lessons": all_lessons}
    )
...
def create_lesson_get(
    ...
    return templates.TemplateResponse(
        "admin/lessons/lesson_create.html", {"request": request}
    )
...
@router.get(
    "/{lesson_id}/edit", response_class=HTMLResponse, status_code=status.HTTP_200_OK
)
def update_lesson_get(
    ...
    return templates.TemplateResponse(
        "admin/lessons/lesson_edit.html", {"request": request, "lesson": lesson}
    )
...
def delete_lesson_get(
    ...
    lesson = lesson_service.get_lesson_by_id(lesson_id)
    return templates.TemplateResponse(
        "delete_lesson_confirm.html", {"request": request, "lesson": lesson}
    )
