...
def get_all_weeks(
    ...
    return templates.TemplateResponse(
        "admin/weeks/weeks_list.html", {"request": request, "weeks": all_weeks}
    )
...
def create_week_get(
    ...
    return templates.TemplateResponse(
        "admin/weeks/weeks_create.html", {"request": request}
    )
...
@router.get(
    "/{week_id}/edit", response_class=HTMLResponse, status_code=status.HTTP_200_OK
)
def update_week_get(
    request: Request,
    week_id: int,
    ...
    return templates.TemplateResponse(
        "admin/weeks/weeks_edit.html", {"request": request, "week": week}
    )
...
def delete_week_get(
    ...
    week = week_service.get_week_by_id(week_id)
    return templates.TemplateResponse(
        "delete_week_confirm.html", {"request": request, "week": week}
    )
